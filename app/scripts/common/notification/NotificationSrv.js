...
(function(angular){
	angular.module('common').service('notify',
		['$timeout','$http','$compile','$templateCache','$rootScope',
    function($timeout,$http,$compile,$templateCache,$rootScope){
    	
    	var startTop = 10;
        var verticalSpacing = 15;
        var defaultDuration = 10000;
        var defaultTemplateUrl = './views/commons/notification/DefaultTemplate.html';
        var position = 'center';
